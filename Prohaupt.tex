...
% Zur Graphikausgabe
%Beipiel: \includepdf[width=\textwidth]{grafik.png}
\usepackage{graphicx}
...
%   {\includepdf[width=0.49\textwidth]{grafik1}}
%   \hfill
%   \subfigure[Beschriftung 2\label{fig:label2}]
%   {\includepdf[width=0.49\textwidth]{grafik2}}
...
%   \centering
%   \includepdf[width=0.5\textwidth]{grafik.png}
